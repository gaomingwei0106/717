        ...
        <div class="home-section main" @scroll="can_i_query && load_more()" ref="main">
            <div class="main-wrap">
                ...
                <div class="hometown">
                    ...
                    <div class="town-cons">
                        <good-comp v-for="items in goods_list" :key="items.goods_id" :id="items.goods_id" :url="items.obj_data" :name="items.goods_name" :price="items.discount_price" @tips-active="tips_active"></good-comp>
                    </div>
